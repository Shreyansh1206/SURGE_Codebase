...
import numpy as np
import torch
from dino_env import N_ACTIONS, OBS_DIM, VecDinoEnv
...
def main():
    ...
    p.add_argument(
        "--n-envs", type=int, default=4, help="Number of parallel browser instances."
    )
    ...
    print(
        f"[train] launching {args.n_envs} parallel Dino envs "
    ...
    try:
        ...
        for update in range(1, args.updates + 1):
            ...
            print(
                f"upd {update:4d} | eps {len(ep_ret):3d} | "
            ...
            if ep_sc and mean_sc == mean_sc and mean_sc > best_mean_score:
                ...
                print(
                    f"        [ckpt] new best mean score {best_mean_score:.1f} -> "
